...
// 			// Handle non-transformed queries
// 			const columns = options.COLUMNS;
// 			const results = data.map((item) => this.mapResult(item, columns, datasetId));
// 			if ("ORDER" in options) {
// 				SortingHelper.applyComplexOrder(results, options.ORDER, columns);
// 			}
// 			return results;
// 		}

// 		// Handle transformed queries
...
// 		// Validate columns with grouping
// 		TransformationHelper.validateColumnsWithGrouping(columns, groupKeys, applyRules);

// 		// Group the data
// 		const groupedData = TransformationHelper.groupData(data, groupKeys, datasetId);

// 		// Apply transformations
// 		const transformedResults = TransformationHelper.applyTransformations(groupedData, applyRules, groupKeys, datasetId);
